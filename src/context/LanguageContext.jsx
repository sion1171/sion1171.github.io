...
const blogPosts = [
  {
    ...
    content: [
      ...
      { type: 'mermaid', caption: 'The full classification pipeline: from raw trade description to standardized product category.', chart: [
        'flowchart TD',
        '    A["Raw Input: FRZ BNLS BUFFALO MEAT NCK 20KG"]',
        '    B["1. Normalize — LLM cleans raw description"]',
        '    C["2. Embed — text-embedding-3-large, 512-dim"]',
        '    D["3. Retrieve — pgvector cosine search, top 12"]',
        '    E["4. Classify — LLM picks best category"]',
        '    F["5. Drill Down — recursive sub-category selection"]',
        '    G["raw-beef / raw-beef-cut / raw-beef-cut-frozen"]',
        '    R["Domain Rules: frozen = preservation, coffee bean = green, butter >= 80%"]',
        '    A --> B --> C --> D --> E --> F --> G',
        '    R -.-> E',
        '    R -.-> F',
        ...
        '    style R fill:#fafaf9,stroke:#d0d0cc,stroke-dasharray:5,color:#555',
      ].join('\n') },
      ...
      { type: 'mermaid', caption: 'A simplified view of the hierarchical product ontology. Red path shows how "frozen boneless buffalo meat" is classified.', chart: [
        'graph TD',
        '    RB["raw-beef"]',
        '    RBC["raw-beef-cut"]',
        '    RBG["raw-beef-ground"]',
        '    RBCF["...-cut-frozen"]',
        '    RBCC["...-cut-chilled"]',
        '    GCB["green-coffee-bean"]',
        '    RCB["roasted-coffee-bean"]',
        '    WR["whole-roasted"]',
        '    GC["ground-coffee"]',
        '    RB --> RBC',
        '    RB --> RBG',
